<details>
 <summary>
         &nbsp;<a href = "https://soup.pw">스프</a> : 흩어져 있는 스터디와 프로젝트가 모여있는 곳🔹기획, 서버 전체 담당.  <sub>(방문자 12만+ , 조회수 110만+, MAU 4천+, 구글검색 1.1위) (22.07 ~ 26.03 서비스 종료)</sub>
 </summary>
&nbsp;
...
- `펄어비스 웹프로그래밍1팀 웹 백엔드` <sub>(24.11 ~ 25.03)</sub>
- `현대오토에버 완성차SDx2팀 백엔드` <sub>(25.07 ~ now) </sub>
<hr>
